 ...
 * Page: Home
 * Group: Hero Section
 * Field: `hero_slides` (Repeater)
 *   - Image (Image Array)
 *   - Label (Text) e.g., "Doma"
 *   - Sublabel (Text) e.g., "Clásica"
 *   - Description (Textarea)
 *   - Link Object (Category Term)
 * 
 * RESPONSIVE GEOMETRY:
 * - Mobile: Flex col (stacked).
 * - Desktop: Flex row, expandable width on hover.
 */
  ...
  return (
    <section className="relative w-full min-h-screen bg-stone-50 px-4 pb-4 pt-24 md:pt-4 md:px-6 md:pb-6 flex flex-col justify-end md:h-screen">
      ...
      <div className="flex-1 w-full flex flex-col md:flex-row gap-4 h-full relative z-10">
          ...
          >
            ...
            <div className="absolute inset-0 p-8 md:p-16 flex flex-col justify-between">
              ...
              <div>
                 ...
                 {/* WP: Use CSS transition max-height/opacity instead of Framer Motion for text reveal */}
                 <motion.div
        ...
        {/* WP: This is a static asset. SVG can be inline or template-part */}

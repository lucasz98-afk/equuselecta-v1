...
/**
 * WORDPRESS TEMPLATE: `single-horse.php`
 * 
 * ACF FIELD GROUP: `horse_details`
 * - Gallery: ACF Gallery field.
 * - Video Reel: File upload or URL.
 * - Tech Specs: Group of text/number fields (Age, Height, Breed, etc).
 * 
 * LOGIC:
 * - Lightbox: Use GLightbox or Fancybox in WP instead of custom React state.
 * - Related Posts: WP_Query filtering by same taxonomy term (`horse_category`).
 */
...
export const HorseDetailPage: React.FC<HorseDetailPageProps> = ({ horse, onBack, onRelatedClick }) => {
  ...
  // States para la galería (En WP usar librería JS externa)
  ...
  // WP Query: 'meta_key' => 'price', 'orderby' => 'meta_value_num'

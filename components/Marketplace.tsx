 ...
 * ----------------------
 * Template: `front-page.php` (part of) or `template-parts/home-marketplace.php`.
 * Query: `new WP_Query(['post_type' => 'horse', 'posts_per_page' => 8])`.
 * 
 * INTERACTION:
 * - This section requires GSAP + ScrollTrigger in WP to handle the horizontal scroll pinned section.
 * - Logic: Container pins, inner content translates X from 0 to -(width - window.width).
 */
...
const HorizontalCard: React.FC<{ horse: Horse; onClick: () => void; index: number }> = ({ horse, onClick, index }) => {
  // WP: Get price via `get_field('price')`
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        {/* WP: `the_post_thumbnail('large', ['class' => '...'])` */}
        <motion.img 
          src={horse.image} 
          alt={horse.name} 
        ...
        />
        {/* Cinematic Noise Overlay - Use static asset URL in WP */}
      ...
      <div className="absolute inset-0 z-10 flex flex-col justify-between p-6 md:p-8">
        ...
        <div className="flex items-start justify-between">
           <div className="flex flex-col gap-2 items-start">
              {/* Reference Tag: ACF field `ref_code` */}
              ...
              {/* Elite Badge: Check Taxonomy `horse_level` == 'alto' */}
              {horse.level === 'alto' && (
                <motion.div 
        ...
        <div className="relative">
          ...
          <div className="mb-6 transform transition-transform duration-700 group-hover:-translate-y-4">
             {/* Discipline Label: Get taxonomy `horse_category` */}
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-[24px] p-1 overflow-hidden transition-all duration-500 group-hover:bg-white/10 group-hover:border-white/20">
             ...
             {/* WP: Wrap this with `<a>` to permalink */}
             <motion.div 
      ...
      >
        <div className="sticky top-0 flex h-screen items-center overflow-hidden bg-black">
          ...
          <motion.div style={{ x }} className="relative z-10 flex gap-8 lg:gap-16 px-12 lg:px-24 items-center">
            ...
            {/* WP: ACF Fields on Home Page for this intro text */}
            ...
            <div className="flex h-[75vh] min-w-[350px] items-center justify-center border-l border-white/10 pl-24">
               {/* WP: Link to /caballos/ (Archive Page) */}

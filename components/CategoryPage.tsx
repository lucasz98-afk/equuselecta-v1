...
import { ArrowUpRight, ArrowRight, Sparkles, Filter, CornerDownRight, AlignLeft, ChevronRight } from 'lucide-react';
 ...
 * WORDPRESS TEMPLATE:
 * -------------------
 * File: `taxonomy-horse_category.php`
 * 
 * ACF MAPPING (Term Fields):
 * - Label / Subtitle
 * - Description
 * - Manifesto Word (e.g. "Harmony")
 * 
 * DATA SOURCE:
 * - This page displays terms of `horse_level` as the panoramic cards.
 * - Beneath, it runs a WP_Query for posts in the current category term.
 */
...
// WP: Iterate over `get_terms('horse_level')` and count posts
const DOMA_LEVELS = [
  { 
    id: 'basico', 
    title: 'Potros', 
    ...
    >
      <div className="w-full overflow-hidden">
        ...
        <section className="relative pt-32 pb-16 md:pt-40 md:pb-24 px-6 container mx-auto text-center">
           ...
           {/* Breadcrumb sutil */}
           {/* WP: Use `yoast_breadcrumb()` or simple link logic */}
           <motion.div 
        ...
        {/* WP: Loop through `get_terms('horse_level')` here */}

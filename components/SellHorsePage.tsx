...
/**
 * WORDPRESS TEMPLATE: `page-vender.php`
 * 
 * FORM HANDLING:
 * - Use Contact Form 7 (CF7) or Gravity Forms.
 * - The HTML structure below should be used as the CF7 template.
 * - Classes like `.group` and `.peer` need to be carefully mapped to CF7 shortcodes.
 * 
 * POLICY MODAL:
 * - Content should be editable in ACF (Wysiwyg field).
 */
